        ...
        <div className="prose prose-gray max-w-none">
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li>Profile information (profile photo)</li>
              <li>Listing information (photos, descriptions, pricing)</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li>Verify your student status via .edu email</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              <li>With other users as part of the normal operation of the service (e.g., your listing information)</li>
